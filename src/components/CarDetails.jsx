      ...
      <Dialog as='div' className='relative z-10' onClose={closeModal}>
        ...
        <div className='fixed inset-0 overflow-y-auto'>
          <div className='flex min-h-full items-center justify-center p-4 text-center'>
            ...
            >
              <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-[#0A0A0A] p-6 text-left shadow-xl transition-all flex flex-col gap-5'>
                <button
                  type='button'
                ...
                <div className='flex-1 flex flex-col gap-2'>
                  <h2 className='font-semibold text-xl text-gray-200 capitalize'>
                    {car.make} {car.model}
                  </h2>
